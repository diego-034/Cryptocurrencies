        ...
        data.forEach((element, index) => {
            body.innerHTML += `<tr>
                                ...
                                <td class="uk-width-small uk-text-right" id="priceC">
                                    $ ${element.price_stats.usd.price_formatted}
                                </td>
                                <td class="uk-table-shrink uk-text-right uk-text-${(color =
                                  element.price_stats.usd.change_1h < 0
                                    ? "danger"
                                    : "success")}">
                                        ${element.price_stats.usd.change_1h}%
                                </td>
                                <td class="uk-table-shrink uk-text-right uk-text-${(color =
                                  element.price_stats.usd.change_24h < 0
                                    ? "danger"
                                    : "success")}">
                                    ${element.price_stats.usd.change_24h}%
                                </td>
                                <td class=" uk-width-max  uk-text-${(color =
                                  element.price_stats.usd.change_7d < 0
                                    ? "danger"
                                    : "success")}">
                                    <img class="svg-icon" src="https://graphs2.coinpaprika.com/currency/chart/${
                                      element.url_name
                                    }/7d/chart.svg"/>
                                    ${element.price_stats.usd.change_7d}%
                                </td>
                                <td class="uk-text-right">
                                    $ ${element.price_stats.usd.volume_24h_formatted}
                                </td>
                                <td class="uk-text-right uk-background-primary">GRAPHIC</td>
                                <td class="uk-text-right">
                                    $ ${element.price_stats.usd.market_cap_formatted} 
                                </td>
                            </tr>`;
        });
